...
/// Creates [ShowcaseConfigData] and provides it
/// through [ShowcaseConfig]
...
class ShowcaseConfig extends InheritedNotifier {
  ...
  const ShowcaseConfig._({
    required Widget child,
    required this.data,
  }) : super(child: child, notifier: data);

  static ShowcaseConfigData of(
    ...
    if (listen) {
      final widget =
          context.dependOnInheritedWidgetOfExactType<ShowcaseConfig>();
...
/// Reactive config for animations (uses [ChangeNotifier])
